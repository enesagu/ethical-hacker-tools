...
def get_user_input():
	...
	parse_object.add_option("-g","--gateway",dest="getaway_ip",help="Enter Gateway IP")
	
	options = parse_object.parse_args()[0]
	
	if not options.target_ip:
		print("Enter Target IP")
	if not options.getaway_ip:
...
user_gateway_ip = user_ips.getaway_ip
...
try:
	...
	while True:
		...
		print("\rMITM PACKET SENDING...: "+str(number),end="")
		number += 3
		time.sleep(3)
